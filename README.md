...
- Bosque VR (`games/bosque-vr`) — ambiente 3D em primeira pessoa pra passear (floresta, lago e sol). Funciona em óculos VR (Meta Quest, WebXR) com o controle, e também no PC (mouse + WASD) e no celular (arrastar + direcional)
